...
def render_field_738cb619(recon_dir, frame_id, score_filtered):
    fps = 30
    t = frame_id / fps
    ...
    ax_score.axvspan(0.6, 5.133, color=cmap(1), alpha=0.5)
    ax_score.annotate("Oscillating",
                      xy=(2.90, -0.1),
                      xycoords="data",
                      va="center",
                      ha="center",
...
select_oc_dir = "recon-20210415_133012-wr518z6d-9000-0.011-f18-738cb619/"
plt.rcParams.update({'font.size': 22})

score, score_filtered, v2_filtered, v2_sim_filtered = analyze_recon(
    select_oc_dir, filter_size=200)

for frame_id in range(2):
    render_field_738cb619(select_oc_dir, frame_id, score_filtered)
